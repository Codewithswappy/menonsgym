...
export default function ProgressStats() {
  const statItems = [
    ...
    { label: 'OPERATIONAL TIMINGS', value: '5:30 AM – 10:30 PM', icon: <Clock className="w-4 h-4 text-slate-950 inline shrink-0" /> },
    { label: 'LOCATION', value: 'GREATER KHANDA PANVEL', icon: <MapPin className="w-4 h-4 text-slate-950 inline shrink-0" /> },
  ...
  return (
    <section className="py-12 bg-white relative overflow-hidden select-none">
      {/* Angled Yellow Ribbon Banner (-rotate-2) */}
      <div className="w-[120%] -ml-[10%] -rotate-2 bg-yellow-400 text-slate-950 py-3.5 shadow-md border-y border-yellow-500 overflow-hidden flex whitespace-nowrap z-10 relative">
        <motion.div
          animate={{ x: [0, -1200] }}
