      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-xl mx-auto space-y-2 mb-12">
          ...
          <p className="text-sm text-slate-600">
            Real everyday members in Greater Khanda who followed structured lifting and nutrition guidelines.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative h-72 sm:h-[380px] w-full rounded-xl overflow-hidden select-none border border-slate-300">
            ...
            />
            <div className="absolute top-3 right-3 px-3 py-1 bg-yellow-500 text-slate-950 font-black text-[10px] uppercase tracking-wider rounded-md z-10 shadow-xs">
              AFTER (Goal Met)
            </div>
            ...
            {/* Slider Divider Line */}
            <div
              className="absolute top-0 bottom-0 w-1 bg-yellow-500 z-20 cursor-ew-resize"
              style={{ left: `${sliderPos}%` }}
            >
              <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-yellow-500 text-slate-950 font-black flex items-center justify-center border-2 border-white text-xs shadow-md">
                ↔
              </div>
            </div>
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs border-t border-slate-200/80 pt-3">
            <div>
              ...
              <span className="text-yellow-700 font-bold ml-2">({TRANSFORMATIONS[0].stats})</span>
            </div>
