          ...
          >
            ...
            <div className="relative overflow-hidden inline-flex items-center gap-2 px-4 py-1.5 bg-white/90 backdrop-blur-md border border-slate-200/90 shadow-[inset_0_2px_4px_rgba(0,0,0,0.06)] rounded-full group cursor-default">
              ...
              <span className="text-xs font-bold text-slate-900 tracking-tight">
                4.9 rating on Google · Greater Khanda, Panvel
              </span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.1] uppercase">
              Build your{' '}
              <span className="bg-yellow-400 text-slate-950 px-2 py-0.5 rounded-md inline-block">
                strongest
              </span>{' '}
              self.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
              <button
                ...
                className="px-6 py-3.5 bg-yellow-400 hover:bg-yellow-300 text-slate-950 font-black rounded-xl text-xs uppercase tracking-wider shadow-xs hover:shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
            ...
            <div className="pt-6 border-t border-slate-200/80 grid grid-cols-3 gap-4 text-xs">
              <div>
                <div className="font-extrabold text-slate-900 text-base">5:30 AM – 10:30 PM</div>
                <div className="text-slate-500 font-medium mt-0.5">Mon–Sat timing</div>
              </div>
              <div>
                <div className="font-extrabold text-slate-900 text-base">Greater Khanda</div>
                <div className="text-slate-500 font-medium mt-0.5">Khanda Colony</div>
              </div>
              <div>
