      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <a href="#hero" className="flex items-center gap-2.5 group">
          {!logoError ? (
            ...
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 bg-yellow-400 text-slate-950 font-black rounded-xl flex items-center justify-center shadow-xs">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-extrabold text-yellow-700 uppercase tracking-widest leading-tight">
                  GYM
                </span>
              </div>
            </div>
        ...
        <div className="hidden sm:flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-bold rounded-lg text-xs tracking-wide transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-white border-t border-slate-100 mt-2"
          >
            <div className="px-4 py-4 space-y-2">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-2.5 bg-yellow-500 text-slate-950 font-bold rounded-lg text-xs text-center"
                >
                  Book free trial
                </button>
              </div>
