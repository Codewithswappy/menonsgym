    ...
    <footer className="bg-slate-50 border-t border-slate-200 text-slate-600 text-xs py-12 pb-20 sm:pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
          ...
          <a href="#hero" className="flex items-center gap-2.5 group">
            {!logoError ? (
              ...
              <div className="flex items-center gap-2.5">
                <div className="w-10 h-10 bg-yellow-400 text-slate-950 font-black rounded-xl flex items-center justify-center">
                  <Dumbbell className="w-5 h-5 stroke-[2.5]" />
                </div>
                <div className="flex flex-col">
                  <span className="text-base sm:text-lg font-black text-slate-900 leading-none">MENON'S</span>
                  <span className="text-[10px] font-extrabold text-yellow-700 uppercase tracking-widest leading-tight">GYM</span>
                </div>
              </div>
            )}
          </a>
        ...
        <div className="pt-6 border-t border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
          <div>
            © {new Date().getFullYear()} {GYM_DETAILS.name}. Greater Khanda, Panvel.
          </div>
