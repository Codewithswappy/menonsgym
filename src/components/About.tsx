  ...
  return (
    <section id="about" className="py-20 sm:py-28 bg-white border-b border-slate-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-20">
        ...
        {/* ========================================================================= */}
        {/* SUB-SECTION 1: Why Choose MENON'S GYM? */}
        {/* ========================================================================= */}
        <div className="space-y-12">
          {/* Centered Heading */}
          <div className="text-center max-w-xl mx-auto space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-yellow-700 bg-yellow-100 px-3 py-1 rounded-full border border-yellow-200/80 inline-block">
              Why Choose Us
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight uppercase">
              Why Choose <span className="text-yellow-600">MENON'S GYM</span>?
            </h2>
            <p className="text-xs text-slate-600">
              The premier results-driven fitness club in Greater Khanda, Panvel.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
            {whyUsCards.map((card, idx) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-slate-50/80 border border-slate-200/80 hover:border-yellow-500/60 hover:bg-white rounded-2xl p-6 text-center space-y-3 transition-all duration-300 shadow-xs hover:shadow-md relative pt-10"
              >
                {/* Top Circular Badge */}
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-yellow-400 text-slate-950 border-2 border-white flex items-center justify-center shadow-xs">
                  {card.icon}
                </div>
        ...
        <div className="space-y-8 pt-8 border-t border-slate-100">
          <div className="text-center max-w-xl mx-auto space-y-2">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight uppercase">
              Quick <span className="bg-yellow-400 text-slate-950 px-2 py-0.5 rounded-md">Facility</span> Overview
            </h2>
            <p className="text-xs text-slate-600">
              Clean air-conditioned floor, industrial equipment, and dedicated parking in Greater Khanda.
            </p>
          </div>
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-slate-50 border border-slate-200/80 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight leading-tight">
                MENON'S GYM is not just a gym — it&apos;s a lifestyle transformation center
              </h3>
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                We combine expert coaching, industrial-grade equipment, and a supportive community atmosphere to help you achieve your full potential in Greater Khanda, Panvel. Whether you are just starting out or pushing for your next strength milestone, MENON'S GYM is where real progress happens.
              </p>

              <div className="pt-2">
                <blockquote className="text-base sm:text-lg font-bold text-slate-900 border-l-4 border-yellow-500 pl-4 py-1.5 italic bg-yellow-50/50 rounded-r-xl">
              ...
              <div className="pt-3">
                <button
                  ...
                  className="px-6 py-3.5 bg-yellow-400 hover:bg-yellow-300 text-slate-950 font-black rounded-xl text-xs uppercase tracking-wider shadow-xs hover:shadow-md transition-all inline-flex items-center gap-2 cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 relative rounded-2xl overflow-hidden border border-slate-200 aspect-[4/3] shadow-xs">
              <Image
                ...
                alt="MENON'S GYM Coaching Session"
                fill
              ...
              <div className="absolute bottom-3 left-3 text-white text-xs font-bold flex items-center gap-1.5">
                ...
                <span>Greater Khanda, Panvel</span>
              </div>
            </div>
          </div>
        </div>
