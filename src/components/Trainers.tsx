        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div className="space-y-1 max-w-xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight uppercase">
              Team of <span className="text-yellow-600">Expert Coaches</span>
            </h2>
          </div>
        </div>
          ...
          {TRAINERS.slice(0, 6).map((trainer, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-3.5 right-3.5 px-2.5 py-0.5 bg-yellow-400 text-slate-950 rounded-md font-black text-[10px] uppercase tracking-wider z-10 shadow-xs">
                  {trainer.experience}
                </div>
                ...
                <div className="absolute bottom-3.5 left-3.5 right-3.5 z-10 text-white flex items-end justify-between">
                  <div>
                    ...
                    <div className="text-[11px] font-bold text-yellow-400 uppercase tracking-wider mt-0.5">
                      {trainer.role}
                    </div>
                  </div>

                  {/* Yellow Arrow Button Icon */}
                  <div className="w-7 h-7 rounded-lg bg-yellow-400 text-slate-950 flex items-center justify-center shrink-0 shadow-xs group-hover:scale-110 transition-transform">
